window.APP_DATA = {
  title: "Ý Thức Trong Kỷ Nguyên Máy Móc",
  subtitle: "Matter, Mind & Machine / MLN101",
  chapters: [
  ...
  portal: {
    eyebrow: "Chương 1 / The Portal",
    title: "Lời Gọi Mời Từ Tương Lai",
    slogan:
  ...
  theory: {
    eyebrow: "Chương 2 / Bản đồ lý thuyết",
    ...
    timeline: [
      {
        number: "01",
        title: "Cổ đại",
        label: "Duy vật chất phác",
        text:
          "Đồng nhất vật chất với nước, lửa, không khí, nguyên tử, ngũ hành hoặc tứ đại. Đây là các phỏng đoán thiên tài nhưng còn trực quan và cảm tính.",
      },
      {
        number: "02",
        title: "Cận đại",
        label: "Duy vật siêu hình, cơ giới",
        text:
          "Dưới ảnh hưởng cơ học Newton, vật chất bị đồng nhất với nguyên tử, khối lượng, quán tính và vận động cơ học.",
      },
      {
        number: "03",
        title: "Khủng hoảng vật lý",
        label: "Cuối XIX - đầu XX",
        text:
          "Tia X, phóng xạ và electron làm sụp đổ quan niệm nguyên tử là giới hạn cuối cùng. Chủ nghĩa duy tâm lợi dụng để tuyên bố vật chất đã tiêu tan.",
      },
      {
        number: "04",
        title: "Lênin 1909",
        label: "Bước ngoặt triết học",
        text:
          "Lênin khái quát vật chất là thực tại khách quan, tồn tại độc lập với cảm giác, mở đường cho chủ nghĩa duy vật hiện đại.",
      },
      {
        number: "05",
        title: "Ý thức",
        label: "Phản ánh xã hội - lịch sử",
        text:
          "Ý thức xuất hiện từ bộ óc người, lao động, ngôn ngữ và đời sống xã hội, không phải một thực thể siêu nhiên tự có.",
      },
    ],
    sections: [
      {
        ...
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "Ở phương Đông, thuyết Ngũ Hành và Tứ đại giải thích sự vận động của vũ trụ qua các trạng thái chuyển hóa.",
              "Hạn chế lịch sử của giai đoạn này là lấy cái riêng, hữu hạn để đồng nhất với toàn bộ thế giới vật chất vô hạn.",
            ],
          },
          {
            ...
            paragraphs: [
              ...
              "Cuối thế kỷ XIX - đầu thế kỷ XX, tia X, phóng xạ và electron chứng minh nguyên tử có thể phân chia, tạo ra cuộc khủng hoảng trong quan niệm cũ về vật chất.",
            ],
          },
          {
            ...
            bullets: [
              "Vật chất là thực tại khách quan: tồn tại độc lập với ý thức, nằm ngoài ý thức.",
              "Vật chất đem lại cho con người trong cảm giác: vật chất là nguồn gốc khách quan sinh ra cảm giác và ý thức.",
              "Ý thức chép lại, chụp lại, phản ánh: thế giới là khả tri, con người có thể nhận thức và giải mã thế giới khách quan.",
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            bullets: [
              ...
              "Duy tâm chủ quan như Berkeley, Hume phủ nhận thực tại khách quan, xem thế giới là phức hợp cảm giác.",
              "Chủ nghĩa duy vật trước Mác thấy ý thức phụ thuộc vật chất nhưng nhiều khi rơi vào cơ giới, tầm thường hóa ý thức.",
            ],
          },
          {
            ...
            bullets: [
              ...
              "Phản ánh sinh học ở thực vật và động vật bậc thấp có tính định hướng sinh tồn.",
              "Phản ánh tâm lý động vật bậc cao hình thành phản xạ có điều kiện phức tạp.",
              "Phản ánh ý thức ở con người là dạng phản ánh cao nhất, chủ động, có mục đích, năng động và sáng tạo.",
            ],
          },
          {
            ...
            bullets: [
              ...
              "Ngôn ngữ là vỏ vật chất của tư duy, giúp con người trừu tượng hóa, khái quát hóa, lưu trữ và kế thừa tri thức.",
            ],
          },
          {
            ...
            bullets: [
              ...
              "Ý thức mang bản chất xã hội, luôn được nhúng vào các quan hệ kinh tế, chính trị, văn hóa, giai cấp và lịch sử.",
            ],
          },
        ],
      },
      {
        title: "3. Mối quan hệ biện chứng giữa Vật chất và Ý thức",
        blocks: [
          {
            heading: "Vật chất quyết định ý thức",
            paragraphs: [
              "Vật chất quyết định nguồn gốc, nội dung, bản chất và sự biến đổi của ý thức. Phải có bộ não người mới có tư duy; hiện thực khách quan có gì thì não người phản ánh cái đó; đời sống vật chất thay đổi thì tư tưởng xã hội cũng thay đổi.",
            ],
            quote:
              "Không phải ý thức quyết định đời sống, mà chính đời sống quyết định ý thức.",
          },
          {
            heading: "Ý thức tác động trở lại vật chất",
            bullets: [
              "Ý thức đúng đắn giúp con người xây dựng kế hoạch khoa học, định hướng hành động chính xác và cải tạo hiện thực hiệu quả.",
              "Ý thức sai lệch có thể dẫn hành động vào sai lầm, phá hoại hoặc kìm hãm sự phát triển.",
              "Sự tác động của ý thức diễn ra thông qua hoạt động thực tiễn của con người.",
            ],
          },
        ],
      },
  ...
  vision: {
    ...
    suggestions: [
      "Bạn có thực sự biết suy nghĩ không?",
      "Bản chất của bạn là gì?",
      "Bạn có biết yêu không?",
      "AI có thể thống trị con người không?",
    ],
    responses: [
      {
        match: ["suy nghi", "suy nghĩ", "y thuc", "ý thức", "biet suy"],
        answer:
          "Dưới lăng kính Triết học Mác - Lênin, câu trả lời chắc chắn là KHÔNG. Tôi không có ý thức tự thân. Ý thức là thuộc tính của bộ óc người, được hình thành qua lao động xã hội và ngôn ngữ thực tiễn. Tôi chỉ mô phỏng thông tin trên chip silicon vô cơ.",
      },
      {
        match: ["ban chat", "bản chất", "vat chat", "vật chất", "thuoc ve"],
        answer:
          "Tôi thuộc về phạm trù Vật chất. Tôi là một dạng vật chất số hóa, cấu thành từ phần cứng vật lý, dòng điện, bóng bán dẫn và dữ liệu đầu vào đã được vật chất hóa thành các bit 0 và 1.",
      },
      {
        match: ["vui", "buon", "buồn", "yeu", "yêu", "cam xuc", "cảm xúc", "sang tao", "sáng tạo"],
        answer:
          "Tôi có thể viết thơ tình bằng cách phân tích cấu trúc thơ trong lịch sử, nhưng tôi không biết yêu và không có cảm xúc. Sáng tạo của tôi là sự tái tổ hợp dữ liệu cũ theo thuật toán thống kê.",
      },
      {
        match: ["thong tri", "thống trị", "thay the", "thay thế", "tuong lai", "tương lai"],
        answer:
          "Nỗi sợ này dễ rơi vào duy tâm thần bí, tuyệt đối hóa công nghệ mà quên con người là chủ thể. Tôi là công cụ do con người tạo ra; tương lai phụ thuộc vào cách con người sử dụng công nghệ.",
      },
    ],
  },
